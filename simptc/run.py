...
def variational_simptc(unlabeled_embeddings, anchors, test_embeddings, test_labels, cov_type="tied", max_iter=50,
                       init_labels=None):
...
def run(dataset, model_name='roberta_large', template_id=1, label_name_file="conceptnet_1000"):
    ...
    prompt_embeddings, prompt_labels = get_prompt(logger, dataset, template_id=template_id,
                                                  label_name_file=label_name_file, model_name=model_name)
    ...
    variational_simptc(unlabeled_embeddings=unlabeled_embeddings, anchors=prompt_cluster_centers,
...
def run_TC14(dataset, model_name='roberta_large', cov_type='tied', max_iter=50, pca_percentage=0.97):
    ...
    variational_simptc(unlabeled_embeddings=unlabeled_embeddings, anchors=prompt_cluster_centers,
                       test_embeddings=text_embeddings,
